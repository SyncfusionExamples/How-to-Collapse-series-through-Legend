...
**Collapse series through legend using ToggleVisibility in Blazor chart**

[Blazor chart](https://www.syncfusion.com/blazor-components/blazor-charts) provide support to collapse the series dynamically by clicking  the respective legend item. You can enable this feature by setting [ToggleVisibility](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Charts.ChartLegendSettings.html#Syncfusion_Blazor_Charts_ChartLegendSettings_ToggleVisibility) to **true**.
